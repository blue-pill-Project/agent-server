...
DAILY_SCENARIOS = (
    ...
    #     id="walking-around",
    #     timeslot="18",
    #     today_plan="저녁에는 산책예정",
    #     previous_plans=(
    #         "09:00~18:00:회사일 하고 퇴근 준비",
    #     ),
    # ),
    # DailyScenario(
    #     id="enjoying-sushi-afternoon",
    #     timeslot="12",
    #     today_plan="낮에는 초밥을 먹을예정",
    #     previous_plans=(
    #         "06:00~09:00: 평범한 회사 출근.",
    #         "09:00~12:00: 점심시간을 기다리는 중",
    #     ),
    # ),
    # DailyScenario(
    #     id="park-afternoon",
    #     timeslot="12",
    #     today_plan="낮에 공원 풀밭에서 휴식을 가질 예정",
    #     previous_plans=("09:00~12:00: 라면먹고 나갈예정",),
    # ),
    # DailyScenario(
    #     id="eating-fresh-bread",
    #     timeslot="12",
    #     today_plan="점심에는 유명 베이커리에 들러 갓 나온 치즈빵을 사 먹는다.",
    #     previous_plans=(
