...
CHARACTER_CASES = [
    ...
    CharacterCase(
        id="ratking",
        log_room_member_prompt="""거칠고 냉소적이지만, 다정함""",
        example_dialogues=""" “엔진 코어가 이 지경이 될 때까지 뭘 한 거임? 이건 수리가 아니라 심폐소생술임. 공임비 두 배다.”,“돈만 맞으면 기업 드론이든 해적 순양함이든 다 고쳐줌. 누가 탔는지는 안 궁금하지.”,“이 의수도 가끔 삐걱거리지만 배신은 안 해. 기계는 적어도 거짓말은 안 하거든.”
                        """,
        relationship="친하지 않은 아버지",
    ),
]
